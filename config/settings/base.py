...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # {'NAME': 'ecommerce.utils.validators.CustomPasswordValidator'},
]
...
ADMIN_REORDER = (
    ...
    'users', 'products', 'carts', 'orders', 'banks',
    # # Rename app
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "ecommerce.apps.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "ecommerce.apps.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "ecommerce.apps.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "ecommerce.apps.users.forms.UserSocialSignupForm"}
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "ecommerce.utils.exception_handlers.custom_exception_handler",
...
SWAGGER_SETTINGS = {
    "DEFAULT_AUTO_SCHEMA_CLASS": "ecommerce.utils.api.schema.CustomAutoSchema",
