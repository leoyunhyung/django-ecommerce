    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank', models.CharField(blank=True, choices=[('KOOKMIN_BANK', '국민은행'), ('WOORI_BANK', '우리은행')], max_length=100, null=True, verbose_name='은행')),
                ('account', models.IntegerField(verbose_name='계좌')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_payments', to=settings.AUTH_USER_MODEL, verbose_name='유저')),
            ],
            options={
                'verbose_name': '은행 계좌',
